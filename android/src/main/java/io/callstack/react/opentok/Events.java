...
enum Events {
    ...
    EVENT_SHARING_FOUND("onSharingFound"),
    EVENT_SHARING_LOST("onSharingLost"),
    ...
    EVENT_SHARING_CONNECTED("onSharingConnected"),
    EVENT_SHARING_RECONNECTED("onSharingReconnected"),
    EVENT_SHARING_DISCONNECTED("onSharingDisconnected"),
