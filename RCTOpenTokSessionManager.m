...
RCT_EXPORT_METHOD(clearSession) {
  NSLog(@"RCTOpenTokSessionManager.clearSession");
  RCTOpenTokSharedInfo *sharedInfo = [RCTOpenTokSharedInfo sharedInstance];
  if (sharedInfo.session != nil) {
...
- (void)session:(OTSession*)session didFailWithError:(OTError*)error {
  ...
  [self.bridge.eventDispatcher sendAppEventWithName:@"onSessionError" body: [NSString stringWithFormat: @"session.didFailWithError: %li %@",(long)error.code,error.localizedDescription]];
}
...
- (void)publisher:(OTPublisherKit *)publisher didFailWithError:(OTError *)error {
  ...
  [self.bridge.eventDispatcher sendAppEventWithName:@"onSessionError" body: [NSString stringWithFormat: @"publisher.didFailWithError: %li %@",(long)error.code,error.localizedDescription]];
}
...
- (void)subscriber:(OTSubscriberKit *)subscriber didFailWithError:(OTError *)error {
  ...
  [self.bridge.eventDispatcher sendAppEventWithName:@"onSessionError" body: [NSString stringWithFormat: @"subscriber.didFailWithError: %li %@",(long)error.code,error.localizedDescription]];
}
